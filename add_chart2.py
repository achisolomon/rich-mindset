...
wb=load_workbook(p); ws2=wb["תוצאות"]
first,last=3,15
data=Reference(ws2,min_col=2,min_row=2,max_row=last)
catref=Reference(ws2,min_col=1,min_row=first,max_row=last)
...
bar.y_axis.scaling.min=0; bar.y_axis.scaling.max=5
bar.x_axis.delete=False; bar.y_axis.delete=False
bar.height=12; bar.width=24; bar.legend=None
...
radar.y_axis.scaling.min=0; radar.y_axis.scaling.max=5
radar.height=12; radar.width=14; radar.legend=None
